...
# ---------- 左手 (left arm) ----------
CALIB_R_LEFT = np.array([[ 0.56637627 , 0.06148352 , 0.82185017],
 [-0.08086318 , 0.9965474 , -0.01882613],
 [-0.82017015 , -0.05579474 , 0.56939255]])
CALIB_T_LEFT = np.array([ 0.0487027  , -0.01075064  , 0.66565227])
...
CALIB_T_RIGHT = np.array([0.1074867, 0.02831579, 0.60470831])
